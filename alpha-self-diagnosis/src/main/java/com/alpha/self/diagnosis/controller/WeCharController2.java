...
//@RestController
@Controller
@RequestMapping("/wechar_old")
public class WeCharController2 {

	@Resource
	private WecharService2 wecharService;
	@Resource
	...
	public ResponseMessage userInfoConfirm(Long userId) {
		...
		UserDiagnosisInfoVo disgnosisInfoVo = wecharService.getUserDiagnosisInfo(userId);
		return WebUtils.buildSuccessResponseMessage(disgnosisInfoVo);
	}
	...
	public ResponseMessage hotDiseaseList() {
		List<DiseaseVo> diseaseVoList = wecharService.listHotDisease();
	...
	public ResponseMessage getUserDiagnosisRecord(Long userId) {
		...
		List<DiagnosisResultVo> resultVoList = wecharService.listUserDiagnosisRecord(userId);
		return WebUtils.buildSuccessResponseMessage(resultVoList);
	}
